    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.travels.update", [$travel->id]) }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('title_en') ? 'is-invalid' : '' }}" type="text" name="title_en" id="title_en" value="{{ old('title_en', $travel->title_en) }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('title_ar') ? 'is-invalid' : '' }}" type="text" name="title_ar" id="title_ar" value="{{ old('title_ar', $travel->title_ar) }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('title_tr') ? 'is-invalid' : '' }}" type="text" name="title_tr" id="title_tr" value="{{ old('title_tr', $travel->title_tr) }}" required>
            ...
            <div class="form-group">
                ...
                <textarea class="form-control ckeditor {{ $errors->has('description_en') ? 'is-invalid' : '' }}" name="description_en" id="description_en">{!! old('description_en', $travel->description_en) !!}</textarea>
            ...
            <div class="form-group">
                ...
                <textarea class="form-control ckeditor {{ $errors->has('description_ar') ? 'is-invalid' : '' }}" name="description_ar" id="description_ar">{!! old('description_ar', $travel->description_ar) !!}</textarea>
            ...
            <div class="form-group">
                ...
                <textarea class="form-control ckeditor {{ $errors->has('description_tr') ? 'is-invalid' : '' }}" name="description_tr" id="description_tr">{!! old('description_tr', $travel->description_tr) !!}</textarea>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('hotel_name') ? 'is-invalid' : '' }}" type="text" name="hotel_name" id="hotel_name" value="{{ old('hotel_name', $travel->hotel_name) }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('visa') ? 'is-invalid' : '' }}" type="text" name="visa" id="visa" value="{{ old('visa', $travel->visa) }}" required>
                @if($errors->has('visa'))
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('airline_tickets') ? 'is-invalid' : '' }}" type="text" name="airline_tickets" id="airline_tickets" value="{{ old('airline_tickets', $travel->airline_tickets) }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('translator') ? 'is-invalid' : '' }}" type="text" name="translator" id="translator" value="{{ old('translator', $travel->translator) }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('days_num') ? 'is-invalid' : '' }}" type="text" name="days_num" id="days_num" value="{{ old('days_num', $travel->days_num) }}" required>
            ...
            <div class="form-group">
                ...
                @foreach(App\Models\Travel::ACTIVE_RADIO as $key => $label)
                    <div class="form-check {{ $errors->has('active') ? 'is-invalid' : '' }}">
                        <input class="form-check-input" type="radio" id="active_{{ $key }}" name="active" value="{{ $key }}" {{ old('active', $travel->active) === (string) $key ? 'checked' : '' }} required>
            ...
            <div class="form-group">
                ...
                <textarea class="form-control ckeditor {{ $errors->has('notes') ? 'is-invalid' : '' }}" name="notes" id="notes">{!! old('notes', $travel->notes) !!}</textarea>
                @if($errors->has('notes'))
