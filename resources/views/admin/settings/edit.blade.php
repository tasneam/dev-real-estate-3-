...
<div class="card">
    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.settings.update", [$setting->id]) }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                <label class="required" for="title_tr">{{ trans('cruds.setting.fields.title_tr') }}</label>
                <input class="form-control {{ $errors->has('title_tr') ? 'is-invalid' : '' }}" type="text" name="title_tr" id="title_tr" value="{{ old('title_tr', $setting->title_tr) }}" required>
                @if($errors->has('title_tr'))
                    <span class="text-danger">{{ $errors->first('title_tr') }}</span>
                @endif
                <span class="help-block">{{ trans('cruds.setting.fields.title_tr_helper') }}</span>
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
                <label for="description_tr">{{ trans('cruds.setting.fields.description_tr') }}</label>
                <textarea class="form-control ckeditor {{ $errors->has('description_tr') ? 'is-invalid' : '' }}" name="description_tr" id="description_tr">{!! old('description_tr', $setting->description_tr) !!}</textarea>
                @if($errors->has('description_tr'))
                    <span class="text-danger">{{ $errors->first('description_tr') }}</span>
                @endif
                <span class="help-block">{{ trans('cruds.setting.fields.description_tr_helper') }}</span>
            </div>
            <div class="form-group">
                <label class="required" for="keywords_en">{{ trans('cruds.setting.fields.keywords_en') }}</label>
                <textarea class="form-control {{ $errors->has('keywords_en') ? 'is-invalid' : '' }}" name="keywords_en" id="keywords_en" required>{{ old('keywords_en', $setting->keywords_en) }}</textarea>
            ...
            <div class="form-group">
                ...
                <textarea class="form-control {{ $errors->has('keywords_ar') ? 'is-invalid' : '' }}" name="keywords_ar" id="keywords_ar" required>{{ old('keywords_ar', $setting->keywords_ar) }}</textarea>
            ...
            <div class="form-group">
                <label class="required" for="keywords_tr">{{ trans('cruds.setting.fields.keywords_tr') }}</label>
                <textarea class="form-control {{ $errors->has('keywords_tr') ? 'is-invalid' : '' }}" name="keywords_tr" id="keywords_tr" required>{{ old('keywords_tr', $setting->keywords_tr) }}</textarea>
                @if($errors->has('keywords_tr'))
                    <span class="text-danger">{{ $errors->first('keywords_tr') }}</span>
                @endif
                <span class="help-block">{{ trans('cruds.setting.fields.keywords_tr_helper') }}</span>
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
                ...
                @if($errors->has('latitudes'))
                    <span class="text-danger">{{ $errors->first('latitudes') }}</span>
                @endif
            ...
            <div class="form-group">
                ...
                @if($errors->has('meridians'))
                    <span class="text-danger">{{ $errors->first('meridians') }}</span>
                @endif
