    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.pages.store") }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <textarea class="form-control {{ $errors->has('keywords_tr') ? 'is-invalid' : '' }}" name="keywords_tr" id="keywords_tr" required>{{ old('keywords_tr') }}</textarea>
            ...
            <div class="form-group">
                ...
                <textarea class="form-control ckeditor {{ $errors->has('short_description_tr') ? 'is-invalid' : '' }}" name="short_description_tr" id="short_description_tr">{!! old('short_description_tr') !!}</textarea>
            ...
            <div class="form-group">
                ...
                @foreach(App\Models\Page::LAYOUT_RADIO as $key => $label)
                    <div class="form-check {{ $errors->has('layout') ? 'is-invalid' : '' }}">
                        <input class="form-check-input" type="radio" id="layout_{{ $key }}" name="layout" value="{{ $key }}" {{ old('layout', '') === (string) $key ? 'checked' : '' }} required>
