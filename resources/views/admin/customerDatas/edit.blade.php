...
<div class="card">
    <div class="card-header">
        {{ trans('global.edit') }} {{ trans('cruds.customerData.title_singular') }}
    </div>

    <div class="card-body">
        <form method="POST" action="{{ route("admin.customer-datas.update", [$customerData->id]) }}" enctype="multipart/form-data">
            @method('PUT')
            @csrf
            <div class="form-group">
                <label class="required" for="name">{{ trans('cruds.customerData.fields.name') }}</label>
                <input class="form-control {{ $errors->has('name') ? 'is-invalid' : '' }}" type="text" name="name" id="name" value="{{ old('name', $customerData->name) }}" required>
                @if($errors->has('name'))
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('email') ? 'is-invalid' : '' }}" type="email" name="email" id="email" value="{{ old('email', $customerData->email) }}" required>
                @if($errors->has('email'))
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('first_phone') ? 'is-invalid' : '' }}" type="text" name="first_phone" id="first_phone" value="{{ old('first_phone', $customerData->first_phone) }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('sec_phone') ? 'is-invalid' : '' }}" type="text" name="sec_phone" id="sec_phone" value="{{ old('sec_phone', $customerData->sec_phone) }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('address') ? 'is-invalid' : '' }}" type="text" name="address" id="address" value="{{ old('address', $customerData->address) }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('nationality') ? 'is-invalid' : '' }}" type="text" name="nationality" id="nationality" value="{{ old('nationality', $customerData->nationality) }}" required>
            ...
            <div class="form-group">
                ...
                <textarea class="form-control ckeditor {{ $errors->has('notes') ? 'is-invalid' : '' }}" name="notes" id="notes">{!! old('notes', $customerData->notes) !!}</textarea>
                @if($errors->has('notes'))
            ...
            <div class="form-group">
                ...
                @foreach(App\Models\CustomerData::ARRIVED_FROM_RADIO as $key => $label)
                    <div class="form-check {{ $errors->has('arrived_from') ? 'is-invalid' : '' }}">
                        <input class="form-check-input" type="radio" id="arrived_from_{{ $key }}" name="arrived_from" value="{{ $key }}" {{ old('arrived_from', $customerData->arrived_from) === (string) $key ? 'checked' : '' }}>
