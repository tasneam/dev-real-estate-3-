...
<div class="card">
    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.realestates.update", [$realestate->id]) }}" enctype="multipart/form-data">
            @method('PUT')
            @csrf
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('video_url') ? 'is-invalid' : '' }}" type="text" name="video_url" id="video_url" value="{{ old('video_url', $realestate->video_url) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('title_en') ? 'is-invalid' : '' }}" type="text" name="title_en" id="title_en" value="{{ old('title_en', $realestate->title_en) }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('title_ar') ? 'is-invalid' : '' }}" type="text" name="title_ar" id="title_ar" value="{{ old('title_ar', $realestate->title_ar) }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('title_tr') ? 'is-invalid' : '' }}" type="text" name="title_tr" id="title_tr" value="{{ old('title_tr', $realestate->title_tr) }}" required>
            ...
            <div class="form-group">
                ...
                <textarea class="form-control ckeditor {{ $errors->has('description_en') ? 'is-invalid' : '' }}" name="description_en" id="description_en">{!! old('description_en', $realestate->description_en) !!}</textarea>
            ...
            <div class="form-group">
                ...
                <textarea class="form-control ckeditor {{ $errors->has('description_ar') ? 'is-invalid' : '' }}" name="description_ar" id="description_ar">{!! old('description_ar', $realestate->description_ar) !!}</textarea>
            ...
            <div class="form-group">
                ...
                <textarea class="form-control ckeditor {{ $errors->has('description_tr') ? 'is-invalid' : '' }}" name="description_tr" id="description_tr">{!! old('description_tr', $realestate->description_tr) !!}</textarea>
            ...
            <div class="form-group">
                ...
                @foreach(App\Models\Realestate::STATUS_RADIO as $key => $label)
                    <div class="form-check {{ $errors->has('status') ? 'is-invalid' : '' }}">
                        <input class="form-check-input" type="radio" id="status_{{ $key }}" name="status" value="{{ $key }}" {{ old('status', $realestate->status) === (string) $key ? 'checked' : '' }} required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('salon_num') ? 'is-invalid' : '' }}" type="number" name="salon_num" id="salon_num" value="{{ old('salon_num', $realestate->salon_num) }}" step="1" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('room_num') ? 'is-invalid' : '' }}" type="number" name="room_num" id="room_num" value="{{ old('room_num', $realestate->room_num) }}" step="1" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('property_type') ? 'is-invalid' : '' }}" type="text" name="property_type" id="property_type" value="{{ old('property_type', $realestate->property_type) }}" required>
            ...
            <div class="form-group">
                ...
                @foreach(App\Models\Realestate::ACTIVE_RADIO as $key => $label)
                    <div class="form-check {{ $errors->has('active') ? 'is-invalid' : '' }}">
                        <input class="form-check-input" type="radio" id="active_{{ $key }}" name="active" value="{{ $key }}" {{ old('active', $realestate->active) === (string) $key ? 'checked' : '' }} required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('year_of_creation') ? 'is-invalid' : '' }}" type="number" name="year_of_creation" id="year_of_creation" value="{{ old('year_of_creation', $realestate->year_of_creation) }}" step="1" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('location') ? 'is-invalid' : '' }}" type="text" name="location" id="location" value="{{ old('location', $realestate->location) }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('owner_name') ? 'is-invalid' : '' }}" type="text" name="owner_name" id="owner_name" value="{{ old('owner_name', $realestate->owner_name) }}">
            ...
            <div class="form-group">
                ...
                <select class="form-control select2 {{ $errors->has('city') ? 'is-invalid' : '' }}" name="city_id" id="city_id" required>
                    @foreach($cities as $id => $entry)
                        <option value="{{ $id }}" {{ (old('city_id') ? old('city_id') : $realestate->city->id ?? '') == $id ? 'selected' : '' }}>{{ $entry }}</option>
                    @endforeach
                </select>
                @if($errors->has('city'))
            ...
            <div class="form-group">
                ...
                <textarea class="form-control ckeditor {{ $errors->has('notes') ? 'is-invalid' : '' }}" name="notes" id="notes">{!! old('notes', $realestate->notes) !!}</textarea>
                @if($errors->has('notes'))
